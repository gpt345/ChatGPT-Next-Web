...
const ru: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      `❗Доменное имя изменится на free.oaibest.com, пожалуйста, обновите закладку. Попробуйте <a href="https://api.oaibest.com" target="_blank">api.oaibest.com</a>, чтобы получить доступ к более чем 450+ моделям, включая OpenAI, Claude, Gemini, Deepseek, Grok, Midjourney и загрузку файлов. Доступные цены, поддержка платежей через Stripe и USDT!`,
  },
  ChatItem: {
  ...
  Store: {
    ...
    BotHello: `❗Доменное имя изменится на free.oaibest.com, пожалуйста, обновите закладку. Попробуйте <a href="https://api.oaibest.com" target="_blank">api.oaibest.com</a>, чтобы получить доступ к более чем 450+ моделям, включая OpenAI, Claude, Gemini, Deepseek, Grok, Midjourney и загрузку файлов. Доступные цены, поддержка платежей через Stripe и USDT!`,
